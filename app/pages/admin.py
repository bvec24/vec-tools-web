    ...
    return rx.el.main(
        ...
        rx.el.div(
            rx.el.div(
                rx.el.h1(
                    "User Management",
                    class_name="text-2xl font-bold text-gray-800 dark:text-white",
                ),
                rx.el.button(
                    "Create User",
                    on_click=AdminState.open_create_user_modal,
                    class_name="bg-purple-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors",
                ),
